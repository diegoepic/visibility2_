...
function getEncuestaPivotConFiltros() {
    ...
    if ($division) {
        $filtros .= " AND l.id_division = $division";
    }
...
// --- Envío de cabeceras para forzar la descarga en Excel ---
...
// Agregar BOM UTF-8 para evitar problemas con acentos
echo "\xEF\xBB\xBF";
echo $shtml;
exit();
?>

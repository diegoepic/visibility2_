...
$query = "
    SELECT 
        ...
        f.nombre AS 'Nombre Campaña',
        l.codigo AS 'ID LOCAL',
        l.nombre AS 'Nombre Local', 
        d.nombre_distrito as 'Distrito',
        d.nombre_distrito as 'Oficina Comercial',
        cm.comuna AS comuna,
        l.direccion AS Direccion,
        l.relevancia as Relevancia,
        v.nombre_vendedor as 'DPM',
        jv.nombre as 'Jefe de Ventas',

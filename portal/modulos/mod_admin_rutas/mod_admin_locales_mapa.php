...
<head>
  ...
  <style>
    ...
    .card-panel > button.btn-outline-secondary {
      top: 10px !important;
      ...
      border-color: rgba(151, 183, 229, 0.35);
    ...
    .filter-control {
      ...
      color: #dceaff;
      background: #14223d;
      border: 1px solid rgba(123, 159, 211, 0.26);
    ...
    .filter-control:focus {
      ...
      background: #182844;
      border-color: #1fd6ff;
      box-shadow: 0 0 0 .14rem rgba(31, 214, 255, .16) !important;
    }
    ...
    .filter-search-btn {
      ...
      font-weight: 800;
      letter-spacing: .6px;
      box-shadow: 0 10px 20px rgba(31, 214, 255, .24);
    }

    .admin-panel-header {
      display: block;
      color: #e7f1ff;
      border-bottom: 1px solid rgba(123, 159, 211, 0.18);
      padding-bottom: 14px;
      margin-bottom: 14px;
    }
    ...
    .admin-panel-counter {
      ...
      border-radius: 8px;
      color: #1fd6ff;
      background: rgba(31, 214, 255, .12);
      border: 1px solid rgba(31, 214, 255, .2);
    }

    .admin-panel-counter span {
      font-size: 20px;
      font-weight: 800;
    }

    .admin-panel-counter small {
      color: #b8c8df;
    }
    ...
    .admin-btn.secondary {
      color: #dceaff;
      background: #1d2d4a;
      border: 1px solid rgba(123, 159, 211, 0.28);
    }
    ...
    .selected-list {
      color: #dceaff;
      border-top: 1px solid rgba(123, 159, 211, 0.18);
      padding-top: 14px;
    }

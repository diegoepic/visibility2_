...
$usuarios = obtenerUsuarios(['estado' => 'todos', 'empresa' => 'todos', 'perfil' => 'todos', 'division' => 'todos']); // Obtener todos los usuarios inicialmente
                          ...
                          <tr id="usuario-<?php echo $usuario['id']; ?>">
                            <td class="uppercase">
                              <?php 
                                echo htmlspecialchars(
                                  mb_strtoupper($usuario['nombre_completo'], 'UTF-8')
                                ); 
                              ?>
                            </td>
                            <td class="uppercase">
                              <?php 
                                echo htmlspecialchars(
                                  mb_strtoupper($usuario['nombre_login'], 'UTF-8')
                                ); 
                              ?>
                            </td>
                            <td class="uppercase">
                              <?php 
                                echo htmlspecialchars(
                                  mb_strtoupper($usuario['nombre_empresa'], 'UTF-8')
                                ); 
                              ?>
                            </td>
                            <td class="uppercase">
                              <?php 
                                $division = !empty($usuario['nombre_division'])
                                  ? $usuario['nombre_division']
                                  : 'N/A';
                                echo htmlspecialchars(
                                  mb_strtoupper($division, 'UTF-8')
                                );
                              ?>
                            </td>
                            <td class="uppercase">
                              <?php 
                                echo htmlspecialchars(
                                  mb_strtoupper($usuario['nombre_perfil'], 'UTF-8')
                                ); 
                              ?>
                            </td>
                            <td>
                            ...
                            <td>
                              ...
                              <?php else: ?>
                                <button
                                  type="button"
                                  class="btn btn-sm btn-secondary reactivar-usuario-btn"
                                  data-id="<?php echo $usuario['id']; ?>"
                                >

...
if (isset($rutas[$mod]['subs']) && $sub !== '' && isset($rutas[$mod]['subs'][$sub])) {
...
<head>
    ...
    <link rel="stylesheet" href="/visibility2/portal/assets/css/layout.css">

    <?php if ($mod === 'home'): ?>
        <link rel="stylesheet" href="/visibility2/portal/css/dashboard1.css">
    <?php endif; ?>
</head>
<body>
...
<?php if ($mod === 'home'): ?>
    ...
    <script src="/visibility2/portal/js/accordeon.js"></script>
<?php endif; ?>

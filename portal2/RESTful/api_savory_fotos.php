...
SUM(
  ...
  SUM(
    ...
    MAX(CASE WHEN q.question_text = 'SUBA UNA FOTO PARA ANTES DE LA GESTION' THEN r.answer_text END) AS FotoAntes,
    MAX(CASE WHEN q.question_text = 'SUBA UNA FOTO PARA DESPUES DE LA GESTION' THEN r.answer_text END) AS FotoDespues

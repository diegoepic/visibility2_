    ...
    <div class="card mb-4">
      <div class="card-body">
        ...
        <div class="form-group">
          ...
          <input type="text" id="buscarLocal" class="form-control" placeholder="Ej: 1234 o Farmacia Central">
...
<script>
  ...
  function buildPreviewItem(qid, respId, url) {
    ...
    img.addEventListener('click', () => verImagenGrande(url));
  ...
  function deleteFotoIW(qid, respId, cardEl) {
    const imgUrl = cardEl.querySelector('img') ? cardEl.querySelector('img').src : '';
    pendingDelete = { qid, respId, cardEl };
    $('#confirmDeleteImg').attr('src', imgUrl);

...
if (!function_exists('deny_auth_json')) {
  function deny_auth_json(string $error = 'AUTH_EXPIRED', string $message = 'Sesión expirada, vuelve a iniciar sesión'): void {
...
if (!function_exists('deny_csrf_json')) {
  function deny_csrf_json(string $message = 'CSRF inválido'): void {
